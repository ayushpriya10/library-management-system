...
class Ui_mainScreen(object):
    def setupUi(self, mainScreen):
        ...
        self.reportTitleLabel.setGeometry(QtCore.QRect(30, 20, 191, 31))
        font = QtGui.QFont()
        ...
        self.bookReportLabel.setGeometry(QtCore.QRect(40, 70, 201, 31))
        font = QtGui.QFont()
        ...
        self.empReportLabel.setGeometry(QtCore.QRect(40, 110, 211, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.generateOverallReport.setGeometry(QtCore.QRect(260, 150, 80, 22))
        self.generateOverallReport.setObjectName("generateOverallReport")
        self.bookDetailsLabel = QtWidgets.QLabel(self.centralwidget)
        self.bookDetailsLabel.setGeometry(QtCore.QRect(40, 190, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.generateBookDetail.setGeometry(QtCore.QRect(260, 190, 80, 22))
    ...
    def retranslateUi(self, mainScreen):
        ...
        self.overallReportLabel.setText(_translate("mainScreen", "Overall Report:"))
        ...
        self.generateBookDetail.setText(_translate("mainScreen", "View Details"))
